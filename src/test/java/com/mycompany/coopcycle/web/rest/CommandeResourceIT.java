...
class CommandeResourceIT {
    ...
    public static Commande createEntity(EntityManager em) {
        Commande commande = new Commande().quantite(DEFAULT_QUANTITE).total(DEFAULT_TOTAL);
        return commande;
    }
    ...
    public static Commande createUpdatedEntity(EntityManager em) {
        Commande commande = new Commande().quantite(UPDATED_QUANTITE).total(UPDATED_TOTAL);
        return commande;
    }
    ...
    void partialUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.quantite(UPDATED_QUANTITE);
    ...
    void fullUpdateCommandeWithPatch() throws Exception {
        ...
        partialUpdatedCommande.quantite(UPDATED_QUANTITE).total(UPDATED_TOTAL);
