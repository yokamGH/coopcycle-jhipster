...
class MenuResourceIT {
    ...
    public static Menu createEntity(EntityManager em) {
        Menu menu = new Menu().nom(DEFAULT_NOM).description(DEFAULT_DESCRIPTION).prix(DEFAULT_PRIX);
        return menu;
    }
    ...
    public static Menu createUpdatedEntity(EntityManager em) {
        Menu menu = new Menu().nom(UPDATED_NOM).description(UPDATED_DESCRIPTION).prix(UPDATED_PRIX);
        return menu;
    }
    ...
    void createMenu() throws Exception {
        ...
        assertThat(testMenu.getPrix()).isEqualTo(DEFAULT_PRIX);
    }
    ...
    void putNewMenu() throws Exception {
        ...
        assertThat(testMenu.getPrix()).isEqualTo(UPDATED_PRIX);
    }
    ...
    void fullUpdateMenuWithPatch() throws Exception {
        ...
        partialUpdatedMenu.nom(UPDATED_NOM).description(UPDATED_DESCRIPTION).prix(UPDATED_PRIX);
